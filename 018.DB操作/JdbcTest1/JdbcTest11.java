 ...
 * @author geust1Day
 */
public class JdbcTest11 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "insert into profiles (profilesID, name,tel,age,birthday) values (3, '辻井伸行','111-2222-3333','100','1994-11-22')";
